...
def create_vector_store(chunks):
    ...
    # ChromaDB ke persistent database se connect karo
    client = chromadb.PersistentClient(path="vector_store")

    # Purani gitsage collection ko delete karo taaki duplicate data na aaye
    try:
        client.delete_collection("gitsage")
    except ValueError:
        pass

    # Fresh vector store create karo
